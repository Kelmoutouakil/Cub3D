...
/*   Updated: 2023/08/18 12:35:46 by kelmouto         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	fill_map(char **p)
{
	...
	p[i++] = strdup("1000001001000001");
	p[i++] = strdup("1000010000100001");
	p[i++] = strdup("1000001001010001");
	p[i++] = strdup("1001000E00001001");
	p[i++] = strdup("1010000000000001");
